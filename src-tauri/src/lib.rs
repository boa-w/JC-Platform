...
use commands::{
    ...
    convert_pdo_simple_project, copy_ui_resource_images, create_project, create_project_window,
    export_canopen_package, export_dbc, export_project_package_command, export_table_csv,
    ...
    import_single_language_csv, inspect_project_git, language_document_table, legacy_table_spec,
    list_project_git_revisions, load_json_file, load_project, load_project_git_context,
    load_project_git_revision, load_project_git_worktree_file, load_project_recovery_draft,
    load_text_file, migrate_project_document, migrate_project_file,
    migrate_unified_protocol_document, open_project_window, parse_pdo_advanced_file,
    parse_pdo_advanced_project, parse_project_document, parse_project_file, parse_ui_resource_file,
    parse_ui_resources, parse_ui_resources_with_project_path, parse_unified_protocol_project,
    pdo_simple_document_table, project_summary, release_project_window,
    remove_ui_resource_option_document, review_project_git_changes, review_project_git_revision,
    save_json_file, save_project, save_project_as_locked, save_project_git_worktree_file,
    save_project_recovery_draft, save_text_file, save_translation_credentials, sdo_document_table,
    ...
    PendingProjectPath, ProjectWindowRegistry,
};
use tauri::{Manager, WindowEvent};

fn dispatch_project_open(app: &tauri::AppHandle, path: String) {
    let app = app.clone();
    tauri::async_runtime::spawn(commands::dispatch_external_project_open(app, path));
}
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .manage(ProjectWindowRegistry::default())
