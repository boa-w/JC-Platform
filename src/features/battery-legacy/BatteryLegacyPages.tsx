...
type DirtyPath = Array<string | number>;

interface BatteryLegacyController {
  currentBatteryProtocolDocument: BatteryProtocol;
  currentBatteryMonitorDocument: BatteryMonitorInfo;
  batteryProtocolExportStatus: string | null;
  batteryProtocolImportStatus: string | null;
  batteryMonitorExportStatus: string | null;
  batteryMonitorImportStatus: string | null;
  batteryCsvStatus: string | null;
  batteryDbcStatus: string | null;
  isExportingBatteryProtocol: boolean;
  isImportingBatteryProtocol: boolean;
  isExportingBatteryMonitor: boolean;
  isImportingBatteryMonitor: boolean;
  isExportingBatteryCsv: boolean;
  isImportingBatteryCsv: boolean;
  isExportingBatteryDbc: boolean;
  isImportingBatteryDbc: boolean;
  handleExportBatteryProtocol: () => Promise<void>;
  handleImportBatteryProtocol: () => Promise<void>;
  handleExportBatteryMonitor: () => Promise<void>;
  handleImportBatteryMonitor: () => Promise<void>;
  handleExportBatteryFramesCsv: () => Promise<void>;
  handleImportBatteryFramesCsv: () => Promise<void>;
  handleExportBatterySignalsCsv: () => Promise<void>;
  handleImportBatterySignalsCsv: () => Promise<void>;
  handleExportBatteryItemsCsv: () => Promise<void>;
  handleImportBatteryItemsCsv: () => Promise<void>;
  handleExportBatteryDbc: () => Promise<void>;
  handleImportBatteryDbc: () => Promise<void>;
  updateBatteryProtocolField: (field: keyof BatteryProtocol, value: unknown) => void;
  updateBatteryMonitorField: (field: keyof BatteryMonitorInfo, value: unknown) => void;
  updateBatteryFrame: (
    index: number,
    field: keyof BatteryMonitorFrame,
    value: string | number,
  ) => void;
  updateBatteryFrameId: (index: number, value: string) => void;
  addBatteryFrame: () => void;
  removeBatteryFrame: (index: number) => void;
  updateBatterySignal: (
    index: number,
    field: keyof BatteryMonitorSignal,
    value: string | number,
  ) => void;
  addBatterySignal: () => void;
  removeBatterySignal: (index: number) => void;
  updateBatteryItem: (
    index: number,
    field: keyof BatteryMonitorItem,
    value: string | number | boolean,
  ) => void;
  updateBatteryItemFormatter: (index: number, field: string, value: string | number) => void;
  updateBatteryItemValidity: (index: number, field: string, value: string | number) => void;
  addBatteryItem: () => void;
  removeBatteryItem: (index: number) => void;
  formatFrameId: (value: number) => string;
  isModifiedPath: (path: DirtyPath) => boolean;
  restoreModifiedPath: (path: DirtyPath) => void;
}
...
export function BatteryProtocolPage({ loadedProject, controller }: BatteryLegacyPageProps) {
  ...
  return (          <section className="table-spec-card">
