...
export const settingDataTypeDefinitions: readonly SettingDataTypeDefinition[] = [
  { handle: 0, name: 'u8', description: '8 位无符号整数', kind: 'integer', bitWidth: 8 },
  { handle: 1, name: 's8', description: '8 位有符号整数', kind: 'integer', bitWidth: 8 },
  { handle: 2, name: 'u16', description: '16 位无符号整数', kind: 'integer', bitWidth: 16 },
  { handle: 3, name: 's16', description: '16 位有符号整数', kind: 'integer', bitWidth: 16 },
  { handle: 4, name: 'u32', description: '32 位无符号整数', kind: 'integer', bitWidth: 32 },
  { handle: 5, name: 's32', description: '32 位有符号整数', kind: 'integer', bitWidth: 32 },
  { handle: 6, name: 'string', description: '字符串', kind: 'string' },
  {
    handle: 7,
    name: 'default_4字节',
    description: '写入 4 字节默认数据',
    kind: 'default-write',
    defaultWriteBytes: 4,
  },
  {
  ...
  },
  {
    handle: 9,
    name: 'default_1字节',
    description: '写入 1 字节默认数据',
    kind: 'default-write',
    defaultWriteBytes: 1,
  },
  { handle: 10, name: 'bits_4字节', description: '32 位位段数据', kind: 'bits', bitWidth: 32 },
  { handle: 11, name: 'bits_2字节', description: '16 位位段数据', kind: 'bits', bitWidth: 16 },
  { handle: 12, name: 'bits_1字节', description: '8 位位段数据', kind: 'bits', bitWidth: 8 },
] as const;
